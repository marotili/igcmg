...
\item \comment{Der Verein, dessen Tätigkeit nicht auf Gewinn gerichtet ist, bezweckt:
...
\comment{Das Anbieten von Experimentierfeldern und Möglichkeiten zum Diskurs zur Auslotung verschiedener Formen, Strömungen und Möglichkeiten des Mediums Spiel; bezogen auf technische, künstlerisch-gestalterische, oder soziale und gesellschaftliche Belange.} \comment{hier noch mehr?}
...
Das Hauptaugenmerk liegt auf der Weitergabe von Wissen und Information zur Gestaltung, Entwicklung und Vermarktung von Spielen. Dies wird durch Abhaltung von Veranstaltungen wie Workshops,
Schulungen und Vorträgen, gerichtet an sowohl bestehende Entwicklerkreise (Vernetzung) als auch an erweiterte Personenkreise (Verbreitung), erreicht.
...
\item \comment{VarA: Vortragsveranstaltungen und Versammlungen, Diskussionsabende}
\item Veranstaltungen und Konferenzen zur Abhaltung von Vorträgen, Schulungen, Diskussionen und Weiterbildungsveranstaltungen
\item Betrieb einer Webseite und \"offentliche Auftritte
\item \comment{VarB: Betrieb und Bereitstellung von technischer Infrastruktur (Website, Mailinglisten etc.) zur Kommunikation zwischen Vereinsmitgliedern untereinander und der allgemeinen Öffentlichkeit;}
...
\item Über die Aufnahme von ordentlichen und au\"serordentlichen Mitgliedern entscheiden der Vorstand. Die Aufnahme kann ohne Angabe von Gründen verweigert werden.
...
Beschluss von mindestens einer Rechnungspr\"uferin oder eines Rechnungspr\"fers (§ 21 Abs. 5 zweiter Satz VereinsG, § 11 Abs. 2 dritter Satz dieser Statuten), oder Beschluss eines gerichtlich bestellten Kurators (§ 11 Abs. 2 letzter Satz dieser Statuten)
...
Juristische Personen werden durch \einen Bevollmächtigt\en vertreten.
...
\item Den Vorsitz in der Generalversammlung führt \der \obmann, in dessen Verhinderung \sein \stv. Wenn auch \dieser verhindert ist, so führt das Vorstandsmitglied, welches am längsten im Verein Mitglied ist, bei Gleichheit das in Jahren älteste anwesende Vorstandsmitglied den Vorsitz.
...
\item Der Vorstand wird vom Obmann/von der Obfrau, bei Verhinderung von seinem/seiner/ihrem/ihrer \stv, schriftlich oder mündlich einberufen. Ist auch \dieser auf unvorhersehbar lange Zeit verhindert, darf jedes sonstige Vorstandsmitglied den Vorstand einberufen.
...
Schriftliche Ausfertigungen des Vereins bedürfen zu ihrer Gültigkeit der Unterschriften \desobmanns und \dessecretary, in Geldangelegenheiten (=vermögenswerte Dispositionen) \desobmanns und \deskassiers.
