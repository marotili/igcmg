...
\item Veranstaltungen zur Abhaltung von Vorträgen, Schulungen und Diskussionen und weitere Veranstaltungen zu den Themen Spieleentwicklung und Spielkultur.
...
\begin{enumerate}
\item Mitglieder des Vereins können alle physischen 
% Personen, die das Mindestbeitrittalter von 16 Jahren erreicht haben,
und juristische Personen, sowie rechtsfähige Personengesellschaften werden.
...
auf schriftlichen begründeten Antrag von mindestens einem Zehntel der stimmberechtigten (§ \ref{sec:rechte-und-pflichten} Abs. \ref{item:mitglieder-stimmrecht} und § \ref{sec:generalversammlung} Abs. \ref{item:gv-stimmrecht}) Mitglieder
